...
class Trainer(object):
    def __init__(self, modules, env, params):
        ...
        if params.reload_data != "":
            ...
            self.data_path = {
                task: (train_path, valid_path, test_path) for task, train_path, valid_path, test_path in s
            }
        ...
        if not params.eval_only:
            ...
            self.dataloader = {
                task: iter(self.env.create_train_iterator(task, self.data_path, params)) for task in params.tasks
            }
